...
-(void)refreshing{
    [NSTimer scheduledTimerWithTimeInterval:2 target:self selector:@selector(nstimerefresh) userInfo:nil repeats:false];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"sundy" forIndexPath:indexPath];
    cell.textLabel.text=@"undy";
    // Configure the cell...
